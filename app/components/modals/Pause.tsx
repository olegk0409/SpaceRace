...
const Pause = ({width, height, coins, setIsPaused, activeAnimations}) => {
  ...
  return (
    <BlurView intensity={100} tint='dark' style={{position: 'absolute', top: 0, right: 0, width: width, height: height, alignItems: 'center', justifyContent: 'center'}}>
      <ImageBackground
        ...
        style={{width: height * 0.8, height: height * 0.8, alignItems: 'center', gap: "10%", zIndex: 10}}
      >
        <Text style={{fontFamily: 'HS', fontSize: 24, color: '#FFF', marginTop: '14%'}}>Pause</Text>
